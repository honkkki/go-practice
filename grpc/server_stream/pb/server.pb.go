...
func init() {
	proto.RegisterType((*HelloRequest)(nil), "server_stream.HelloRequest")
	proto.RegisterType((*HelloReply)(nil), "server_stream.HelloReply")
}
...
var fileDescriptor_98d161fbd54d4312 = []byte{
	...
	0x4e, 0x2d, 0x2a, 0x4b, 0x2d, 0xd2, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x85, 0xf0, 0xe2,
	0x8b, 0x4b, 0x8a, 0x52, 0x13, 0x73, 0x95, 0x94, 0xb8, 0x78, 0x3c, 0x52, 0x73, 0x72, 0xf2, 0x83,
	...
	0x21, 0x09, 0x2e, 0xf6, 0xdc, 0xd4, 0xe2, 0xe2, 0xc4, 0x74, 0x98, 0x22, 0x18, 0xd7, 0x28, 0x94,
	0x8b, 0xdd, 0xbd, 0x28, 0x35, 0xb5, 0x24, 0xb5, 0x48, 0xc8, 0x8b, 0x8b, 0x27, 0x38, 0xb1, 0x12,
	0xac, 0xcb, 0x27, 0xb3, 0xb8, 0x44, 0x48, 0x5a, 0x0f, 0xc5, 0x5a, 0x3d, 0x64, 0x3b, 0xa5, 0x24,
	0xb1, 0x4b, 0x16, 0xe4, 0x54, 0x2a, 0x31, 0x18, 0x30, 0x26, 0xb1, 0x81, 0x1d, 0x6e, 0x0c, 0x08,
	0x00, 0x00, 0xff, 0xff, 0x92, 0x10, 0x51, 0xe2, 0xcb, 0x00, 0x00, 0x00,
}
...
func (c *greeterClient) SayHelloList(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Greeter_SayHelloListClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[0], "/server_stream.Greeter/SayHelloList", opts...)
	if err != nil {
		return nil, err
	}
...
func (*UnimplementedGreeterServer) SayHelloList(req *HelloRequest, srv Greeter_SayHelloListServer) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloList not implemented")
}
...
var _Greeter_serviceDesc = grpc.ServiceDesc{
	ServiceName: "server_stream.Greeter",
